...
unsigned int syscall_get_arg1(void)
{
  ...
  return (unsigned int)uctx_pool[curID].regs.eax;
  //return 0;
}
...
unsigned int syscall_get_arg2(void)
{
  ...
  return (unsigned int)uctx_pool[curID].regs.ebx;
  //return 0;
}
...
unsigned int syscall_get_arg3(void)
{
  ...
  return (unsigned int)uctx_pool[curID].regs.ecx;
  //return 0;
}
...
unsigned int syscall_get_arg4(void)
{
  ...
  return (unsigned int)uctx_pool[curID].regs.edx;
  //return 0;
}
...
unsigned int syscall_get_arg5(void)
{
  ...
  return (unsigned int)uctx_pool[curID].regs.esi;
  //return 0;
}
...
unsigned int syscall_get_arg6(void)
{
  ...
  return (unsigned int)uctx_pool[curID].regs.edi;
  //return 0;
}
...
void syscall_set_errno(unsigned int errno)
{
  ...
  uctx_pool[curID].err = (uint32_t) errno;
...
void syscall_set_retval1(unsigned int retval)
{
  ...
  uctx_pool[curID].regs.ebx = (uint32_t) retval;
...
void syscall_set_retval2(unsigned int retval)
{
  ...
  uctx_pool[curID].regs.ecx = (uint32_t) retval;
...
void syscall_set_retval3(unsigned int retval)
{
  ...
  uctx_pool[curID].regs.edx = (uint32_t) retval;
...
void syscall_set_retval4(unsigned int retval)
{
  ...
  uctx_pool[curID].regs.esi = (uint32_t) retval;
}
...
void syscall_set_retval5(unsigned int retval)
{
  ...
  uctx_pool[curID].regs.edi = (uint32_t) retval;
}
